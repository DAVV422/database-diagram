...
import { NgDiagramHelper } from '../ng-diagram-helper/ng-diagram-helper.component';
...
export class OverviewComponent {
  ...
  /** The Overview itself  */
  public overview!: go.Overview | null;
  ...
  public ngOnChanges(changes: SimpleChanges) {
    ...
    if (changes && (changes as any).observedDiagram && (changes as any).observedDiagram.currentValue !== (changes as any).observedDiagram.previousValue) {
      this.overview.observed = (changes as any).observedDiagram.currentValue;
    }
  }
