...
export class DiagramComponent {
   ...
   */
   ...
   @Input() public linkDataArray: Array<go.ObjectData> | null = null;
   /** Model data for diagram. Optional. */
   @Input() public modelData: go.ObjectData | null = null;
   ...
   public ngOnChanges() {
     ...
     if (this.wasCleared) {
       this.diagram.delayInitialization(() => {
         NgDiagramHelper.mergeAppDataWithModel((this as any), true);
       });
       this.wasCleared = false;
     } else {
       NgDiagramHelper.mergeAppDataWithModel((this as any));
     }
   } // end ngOnChanges
